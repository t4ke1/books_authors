    ...
    public function onKernelException(ExceptionEvent $event): void
    {
        ...
        switch (true) {
            ...
            case $exception instanceof TransportExceptionInterface:
                $response = new JsonResponse('Something with send message went wrong', Response::HTTP_INTERNAL_SERVER_ERROR);
                $this->logger->error('An exception occurred in TransportExceptionInterface scenario', ['exception' => $exception]);
                break;
            default:
